  ...
  <div>
    ...
    >
      ...
      >
        ...
        <el-form-item label="课程地点" prop="courselocation">
          <el-input v-model="addCourseForm.courselocation"></el-input>
        </el-form-item>
    ...
    >
      ...
      >
        ...
        <el-form-item label="课程地点" prop="courselocation">
          <el-input v-model="editCourseForm.courselocation"></el-input>
        </el-form-item>
        <el-form-item label="课程时间" prop="coursetime">
          <el-input v-model="editCourseForm.coursetime"></el-input>
        </el-form-item>
      </el-form>
      <span slot="footer" class="dialog-footer">
...
export default {
  ...
  methods: {
    ...
    async userStateChanged (courseInfo) {
      const { data } = await this.$http.put(
        `/users/${courseInfo.id}/state/${courseInfo.mg_state}`
      )
