...
public class Course_userHandler {
    ...
    public List<Course_user> findcourseByuserId(@RequestParam Integer userid) {return course_userService.findcourseByuserId(userid);}


    @GetMapping("/findexpBycourseId")
    public List<Course_user> findexpBycourseId(@RequestParam Integer courseid) {return course_userService.findexpBycourseId(courseid);}
